...
SET LDFLAGS=%LDFLAGS% -X %CMD_PKG%.Mingw64URL=https://sourceforge.net/projects/mingw-w64/files/Toolchains%20targetting%20Win64/Personal%20Builds/mingw-builds/8.1.0/threads-posix/seh/x86_64-8.1.0-release-posix-seh-rt_v6-rev0.7z/download?use_mirror=tenet&download=&failedmirror=liquidtelecom.dl.sourceforge.net
